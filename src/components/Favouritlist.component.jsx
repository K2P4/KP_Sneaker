		...
		<div className=" mt-4">
			{fav?.map((item) => (
				<div className=" border mb-2 shadow-md hover:shadow-slate-500 duration-300   group px-4 relative rounded-md bg-slate-200 ">
					...
					<p className="bg-white bottom-0 left-0 w-[25%] text-black p-2 absolute">
						$ {item.price}
					</p>
					...
					<div className="flex flex-col items-center gap-2 absolute top-2 right-2">
						<button className=" ">
							<svg
								...
								viewBox="0 0 24 24"
								fill="currentColor"
								className=" w-9 border active:scale-95 border-slate-400 p-1  duration-700 animate__zoomIn   animate__animated  text-gray-900 rounded-sm     h-9">
